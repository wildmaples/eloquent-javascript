...
// numbers and returns the sum of these numbers. Run the 
...
// “step” value used when building the array. If no step 
// is given, the elements go up by increments of one, 
// corresponding to the old behavior. The function call 
// range(1, 10, 2) should return [1, 3, 5, 7, 9]. Make 
// sure it also works with negative step values so that 
// range(5, 2, -1) produces [5, 4, 3, 2].

function range(start, end, step = 1) {
  difference = (Math.abs(start-end) + 1) / Math.abs(step)
  listOfNum = []
